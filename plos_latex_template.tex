...
\caption{Distribution of firing rates acquired by solving the diffusive homeostatic fixed point. 2D variant was carried out on a $\rm 2000x2000\, \upmu m$ sheet (grid resolution $\rm 200x200$) and $8000$ randomly picked cell positions. 3D variant used a $\rm 1000x1000x1000\, \upmu m$ cube (grid resolution $\rm 100x100x100$) and $\rm 9\cdot 10^4$ random cell positions. 3D variant with a flat neural tissue used a $\rm 2000x2000x1000\, \upmu m$ cube (grid resolution $\rm 200x200x100$) and $80000$ cell positions with random x- and y-coordinates and a z-coordinate fixed at $\rm 500\, \upmu m$. All graphs depict single trial data.}
...
!!!(Comment) If we want to back up this hypothesis by experimental findings, there should be at least some evidence that the concentration of NO is actually at least approximately constant throughout neuronal cell bodies. I could not find any reports that support this, and instead even found contradicting reports on considerably varying NO concentrations. I think we should not try to push our hypothesis too far here. !!!
