...
Fig. \ref{Syn_Topology_Features} summarizes the results regarding these properties. As shown in Panel A and B, Diffusive homeostasis leads to the same stable level of recurrent excitatory connection fraction, as well as an over-representation of bidirectional connections in the case of non-uniform connection profile (denoted by ``topology"), as reported previously \cite{SORN_Paper}. A more general discussion on this issue was provided by Hoffmann and Triesch \cite{Hoffmann_2017}.
