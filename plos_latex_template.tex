...
%%% out_weight_vs_f.py
\includegraphics[width=\textwidth]{../../plots/paper/outgoing_weights_comp_new_cumsum.png}
...
\caption{Distribution of firing rates acquired by solving the diffusive homeostatic fixed point. 2D variant was carried out on a $\rm 2000 \times 2000\, \upmu m^2$ sheet (grid resolution $\rm 200 \times 200$) and $8000$ randomly picked cell positions. 3D variant used a $\rm 1000 \times 1000 \times 1000\, \upmu m^3$ cube (grid resolution $\rm 100 \times 100 \times 100$) and $\rm 9\cdot 10^4$ random cell positions. The 3D variant with a flat neural tissue used a $\rm 2000 \times 2000 \times 1000\, \upmu m^3$ cube (grid resolution $\rm 200 \times 200 \times 100$) and $8000$ cell positions with random x- and y-coordinates and a z-coordinate fixed at $\rm 500\, \upmu m$. All graphs depict single-trial data.}
